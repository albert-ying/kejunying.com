...
My research vision is to establish cellular aging as a tractable computational problem with engineered solutions by integrating causal AI models with evolutionary protein design. I aim to understand fundamental mechanisms of how cells maintain physiological function across the lifespan and translate these insights into precision therapeutics.

My training bridges computational and experimental approaches to aging biology. During my Ph.D. with Vadim Gladyshev at Harvard, I developed causality-enriched epigenetic clocks, foundation models for DNA methylation, and AI platforms for systematic intervention discovery. My postdoctoral work with Tony Wyss-Coray at Stanford on plasma proteomics and with David Baker at the University of Washington on protein design has prepared me to combine computational discovery with experimental validation and therapeutic engineering. This interdisciplinary training positions me to address fundamental questions in biochemistry and biophysics using modern computational and systems biology approaches.

UCSF's Department of Biochemistry and Biophysics provides an ideal environment for my research program. The department's strength in structural biology, computational biology, and systems approaches aligns perfectly with my vision. I envision collaborations with faculty in cryo-EM for structural characterization of engineered proteins, mass spectrometry experts for proteomic validation, and computational biologists for developing causal AI frameworks. The Mission Bay Campus's state-of-the-art facilities, including advanced microscopy, cryo-EM, and high-throughput screening capabilities, would enable comprehensive investigation of cellular aging mechanisms and validation of designed therapeutics. I would benefit from UCSF's collaborative culture and contribute by bringing expertise in causal inference, foundation models, and protein engineering while mentoring diverse students in quantitative approaches to fundamental biology.

My future research program will develop causal multimodal foundation models to identify aging mechanisms, build AI agent platforms for intervention discovery, and engineer therapeutic proteins informed by evolutionary principles. This integrated approach will advance our understanding of cellular physiology while creating new tools for intervention in age-related cellular dysfunction.
